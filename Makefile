...
docker-run:
	sudo docker run -e MYSQL_HOST=172.17.0.1 -e MYSQL_PORT=3306 -e MYSQL_USER=root -e MYSQL_PASSWORD=root -e MYSQL_DBNAME=skyshi_gethired -p 8090:3030 ezizull/skyshi-gethired:$(tag)